	...
	<article>
		...
		<div class="search" style="background-color: rgba(255, 255, 255, 0.2); margin-left: 40px; width: 89%;">
			<!-- <div class="qes1">
				...
				<a href="twoving.do?command=servicerun&inquirylist=서비스 이용" onClick=""><img src="images/search.png" width="80"></a>
			</div>
			<br><br> -->
		...
		<table style="display: flex; flex-direction:column;">
			<c:forEach items="${passTicket}" var="pt" varStatus="loop">
				...
				<tr class="faq-content" style="display:none;">
            		...
            		<td class="faq-content-tcol" colspan="3" style="display:block; text-align:center;"><pre>${pt.content}</pre></td>
       			</tr>
			</c:forEach>
		</table>
		
		<jsp:include page="paging/passTicketPaging.jsp">
			<jsp:param value="twoving.do?command=passTicket&amp;inquirylist=이용권/결제" name="address"/>
		</jsp:include>
